...
您在使用AI工具的时候是否遇到以下问题？
- 用AI做项目，明明知道自己想要什么，但就是表达不清楚、不专业？
- 让AI去做，结果ta理解偏了自己的需求？
- 自己还没确定AI是否理解，AI就直接开始写代码，结果发现错在起跑线上了？

Intent Debugger 将会完成以下任务：

- 找到合适的专业术语，把用户的描述整理成清楚的需求；
- 梳理关键目标、核心功能等，形成结构化方案；
- 找出描述中的歧义、冲突、边界情况和潜在风险；
- 通过具体反问，根据你的回答动态调整方案，确认双方意见统一；
- 不主动开始执行，客观评价当前方案以及与用户需求的对齐程度。
